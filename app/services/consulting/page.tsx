...
export default function ConsultingPage() {
  return (
    <>
      {/* FULL-SCREEN HERO (full-bleed, white headline) */}
      <header className="relative h-[85vh] md:h-screen w-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full">
          <div className="mx-auto flex h-full max-w-6xl flex-col justify-center px-6 md:px-10 text-white">
            ...
            <h1 className="mt-2 text-4xl font-extrabold tracking-tight md:text-6xl text-white">
              Blueprint for Giants
            </h1>
            <p className="mt-4 max-w-2xl text-base md:text-lg text-white/90">
              Customized, boots-on-the-ground strategy to engineer your property
              for mature whitetails—without guesswork. You’ll know exactly what
              to do, where, and why.
            </p>
      ...
      <main className="mx-auto max-w-6xl px-6 pb-24 pt-12">
        ...
        <section id="decision" className="mt-16">
          <div className="rounded-2xl bg-brand-50 p-6 md:p-8 border border-brand-100">
            ...
            <p className="mt-2 max-w-3xl text-zinc-700">
              Start with a plan. Then either do it yourself or have us build it
              for you. Already have a plan? Skip straight to implementation.
            </p>
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-3">
              ...
              <div className="rounded-2xl bg-white p-6 shadow-soft border border-zinc-200">
                ...
                <p className="mt-2 text-zinc-700">
                  We create your Blueprint for Giants. You (or your crew)
                  implement it at your pace with clear maps, priorities, and
                  steps.
                </p>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-soft border border-zinc-200">
                ...
                <p className="mt-2 text-zinc-700">
                  We design your blueprint and manage habitat implementation
                  with our trusted partners—built right, the first time.
                </p>
                <ul className="mt-4 space-y-2 text-sm text-zinc-700">
            ...
            {[
              {
                ...
                d:
                  "We learn your goals, acreage, pressure, and timeline—and confirm fit.",
              },
              {
                n: "02",
                t: "On-Site Assessment",
                d:
                  "We walk the property, analyze access/wind/pressure, and mark improvements.",
              },
              {
                n: "03",
                t: "Blueprint for Giants",
                d:
                  "You receive maps, priorities, and phased steps for DIY or DFY execution.",
              },
            ].map((s) => (
              <div
                key={s.n}
        ...
        <section className="mt-16 rounded-2xl border border-zinc-200 bg-white p-6 md:p-8 shadow-soft">
          ...
          <p className="mt-3 text-zinc-700 max-w-4xl">
            Our lead consultant, <span className="font-semibold">Kent</span>,
            blends formal training in forestry and wildlife/habitat from Penn
            State, research experience with the PSU deer lab, and years of
            designing and building improvements on real hunting properties. That
            mix—biology, timber, undetectable access, and on-the-ground
            execution—produces plans that actually work for big, mature bucks.
          </p>
          <div className="mt-5">
        ...
        <section className="mt-16 rounded-2xl bg-brand-700 px-6 py-10 text-white">
          ...
          <p className="mt-2 text-white/90">
            Start with a free, no-pressure strategy call. We’ll point you to the
            best next step—DIY, DFY, or straight to implementation.
          </p>
          <div className="mt-5">
            <CtaSafe href="/contact">Book a Free Strategy Call</CtaSafe>
          </div>
