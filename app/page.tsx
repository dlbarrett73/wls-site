  ...
  return (
    <main className="mx-auto max-w-6xl px-6 pb-24 pt-12">
      ...
      <section className="relative overflow-hidden rounded-3xl shadow-soft">
        ...
        />
        <div
          className="absolute inset-0 bg-gradient-to-b from-brand-900/70 via-brand-800/70 to-brand-900/80"
          aria-hidden
        />
      ...
      {/* CHANNEL TRAILER (YouTube) */}
      {/* (keep your existing YouTube embed section here) */}

      {/* LATEST PROPERTY SHOWCASE (YouTube) */}
      {/* (keep your existing YouTube embed section here) */}

      {/* SITE-WIDE CTA STRIP */}
      {/* (keep your existing CTA section here) */}
    </main>
  );
}
